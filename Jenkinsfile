...
pipeline {
    ...
    stage('SonarQube Scan') {
      steps {
        sh """mvn sonar:sonar \
              ...
              -Dsonar.host.url=http://172.31.21.196:9000 \
              -Dsonar.login=52109b913cf9cc54030379f904a8e170f10cf50c"""
      }
    }
  ...
  post {
    always {
        ...
        slackSend channel: '#phil-jenkins-cicd-pipeline-alerts', //update and provide your channel name
